...
namespace TemPloy.Models
{
	...
	class JSFeedback
	{
		...
		public JSFeedback(int Id, string EntName, string EntUsername, string SeekerName, string SeekerUsername, int Submissionid , DateTime SaveDate, string Review, double Rating)
		{
			this.Id = Id;
